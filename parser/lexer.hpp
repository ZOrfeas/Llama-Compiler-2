...
// //   depending on Lexer paramereters, the Lexer can try to recover and store
// the
...
//         //! NOTE: I'll keep track of active filename by keeping the indexes
//         and
...
//         auto match_with_str(std::string_view, lexeme_t) ->
//         std::optional<token>;

//         template <src_pos_advancer F>
//         inline auto finalize_token(lexeme_t tok_type,
//                                    Source::const_iterator tok_val_end_it, F
//                                    f)
//             -> token {
...
//         /**
//          * @brief Given iterator is advanced up until after the first non
//          digit
//          * character
//          */
