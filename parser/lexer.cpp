...
//     : owned_src(std::move(Source(filename, crash_on_error))),
//     src(*owned_src),
//       crash_on_error(crash_on_error), tokens({}), errors({}) {}
...
//         lexeme_t::COMMENT, tmp_src_it, [this, tmp_src_it](source_position
//         pos) {
...
//                                   pos.colno +=
//                                   std::distance(this->state.src_it,
//                                                              tmp_src_it);
//                                   return pos;
//                               });
//     }
...
//         '"'}; if (std::find(escapable_chars.begin(), escapable_chars.end(),
//         c) !=
//             escapable_chars.end()) {
//             return true;
//         }
...
//             return true;
//         }
//         throw parse_error{this->state.cur_pos, "invalid hex escape
//         sequence"};
//     };
...
//     // TODO: implement some kind of error tolerance e.g. eat up until
//     whitespace return finalize_token(
